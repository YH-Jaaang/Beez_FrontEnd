      ...
      <b-form @submit.prevent="submitForm">
        ...
        <b-modal id="modal1" hide-footer title="BEEZ 서비스 이용약관 내용">
          <ul>
            ...
            <p>
              ...
              약관은 다양한 BEEZ 서비스의 이용과 관련하여 서비스 회원가입 시
              상황을 설명하며, 아울러 여러분의 BEEZ 서비스 이용에 도움이 될 수
            ...
            <p>
              BEEZ는 소상공인과 소비자의 거래 서비스를 제공하고 여러분의 생활에
              편리함을 더할 수 있는 다양한 서비스를 제공하고 있습니다. 여러분은
              PC, 휴대폰 등 인터넷 이용이 가능한 각종 단말기를 통해 각양각색의
              서비스를 자유롭게 이용하실 수 있으며, 개별 서비스들의 구체적인
              내용은 각 서비스 상의 안내, 공지사항, Q&A, 웹고객센터(이하
              ‘고객센터’) 도움말 등에서 쉽게 확인하실 수 있습니다.
            </p>
            <p>반드시 회원으로 가입하셔야 BEEZ 서비스를 이용할 수 있습니다.</p>
            <p>
        ...
        <b-modal id="modal2" hide-footer title="개인정보 취급 위탁 동의설명">
          ...
          <p>
            ...
            수집합니다. 회원가입 시점에 BEEZ가 이용자로부터 수집하는 개인정보는
            아래와 같습니다.
          </p>
          <p>
            - 회원 가입 시에 ‘이메일, 비밀번호, 이름, 휴대전화번호’를
            필수항목으로 수집합니다. 서비스 이용 과정에서 이용자로부터 수집하는
            개인정보는 아래와 같습니다. BEEZ 내의 개별 서비스 이용, 이벤트 응모
            및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보
            수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당
            개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목,
            개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고
            동의를 받습니다. 서비스 이용 과정에서 IP 주소, 쿠키, 서비스 이용
          ...
          <p>
            - 법령 및 BEEZ 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정
            이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한
            방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항
